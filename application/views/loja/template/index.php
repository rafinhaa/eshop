												...
												<div class="col-xl-3 col-lg-4 col-md-4 col-12">
													<div class="single-product">
														<div class="product-img">
															<a href="<?= base_url('produto/' . $d->meta_link) ?>">
																<img class="default-img" src="<?= base_url('upload/produtos/'.$d->foto) ?>" alt="#">
																<img class="hover-img" src="<?= base_url('upload/produtos/'.$d->foto) ?>" alt="#">
															</a>
														...
														<div class="product-content">
															<h3><a href="<?= base_url('produto/' . $d->meta_link) ?>"><?= $d->nome ?></a></h3>
															<div class="product-price">
																<span><?= formataMoedaReal($d->valor) ?></span>
															</div>
														</div>
													</div>
												</div>
